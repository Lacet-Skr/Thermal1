<%-- 
    Document   : cargacot
    Created on : 17/10/2019, 10:00:28 AM
    Author     : Tecra
--%>
<%@page import="java.util.ArrayList" %>
<%@page import="Clase.Cotizacion" %>
...
.tbl tr:first-child td:last-child{
    ...
    <body>
        <%
            ...
            ArrayList<Cotizacion> list = CotizacionCon.listarCotizacion(nombre);
            String pag = request.getParameter("pag");
            String link = null;
            String evento = request.getParameter("evento");
            
            if("cotizaciones".equals(pag)){
        ...
        <div class="tbl">
            <table width="60%" border="0">
                <tbody>
                    ...
                    <tr>
                        <td align="center"><%= c.getIdcotizacion()%></td>
                        <td align="center"><%= c.getClientecotizacion()%></td>
                        <td><a href="<%= link + c.getIdcotizacion()%>">Ver</a></td>                        
                    </tr>                    
                    <%}%>
                </tbody>
            </table>
