<%-- 
    Document   : cargaper
    Created on : 11/09/2019, 03:00:02 PM
    Author     : LACET
--%>
...
.tbl tr:first-child td:last-child{
    ...
    <body>
        <%
            ArrayList<Vendedores> list = VendedorCon.listarVendedores();
            //String pag = request.getParameter("pag");
            String link = null;
            //String evento = request.getParameter("evento");
            //el mismo proceso para alumnos, clases y calificaciones
            //if("vendedores".equals(pag)){
                link = "/Garniet/Controlador?accion=guardar&tab=vendedores&evento=buscar&par=";
           // }
...
<div class="tbl">
        <table width="100%" border="0">
            <tbody>
                ...
                <tr>
                    <td align="center"><%= v.getIdvendedor()%></td>
                    <td align="center"><%= v.getNombrevendedor()%></td>
                  <td><a href="<%= link + v.getIdvendedor()%>" > Ver</a></td>
                </tr>
                <%}%>
            </tbody>
        </table>
