...
.tbl tr:first-child td:last-child{
	border-width:0px 0px 1px 1px;
        ...
        <%
            ...
            ArrayList<Linea> list = LineaCon.listarLinea(descripcion);
            String pag = request.getParameter("pag");
            String link = null;
            String evento = request.getParameter("evento");
            //el mismo proceso para alumnos, clases y calificaciones
            if("lineas".equals(pag)){
                link = "/thermal/Controlador?accion=guardar&tab=lineas&evento=buscar&par=";
            }else if("productos".equals(pag)){
                link = "/thermal/Controlador?accion=guardar&tab=lineas&evento=buscarpro&par=";
            }
        %>
<div class="tbl">
        <table width="100%" border="0">
            <tbody>
                ...
                <tr>
                    ...
                    <td align="center"><%= l.getClavelinea()%></td> 
