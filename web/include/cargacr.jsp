<%-- 
    Document   : cargacr
    Created on : 6/09/2019, 04:02:40 PM
    Author     : Tecra
--%>
<%@page import="Clase.Creditos"%>
...
.tbl tr:first-child td:last-child{
    ...
    <body>
        <%            
            ArrayList<Creditos> list = CreditoCon.listarCreditos2();
            String pag = request.getParameter("pag");
            String link = null;
            String evento = request.getParameter("evento");
            
            if("creditos".equals(pag)){
                link = "/thermal/Controlador?accion=guardar&tab=creditos&evento=buscar&par=";
            }
        %>
        <div class="tbl">
            <table width="100%" border="0">
                <tbody>
                    ...
                    <% for (Creditos d : list) {%>
                    <tr>
                        <td align="center"><%= d.getIdcredito()%></td>
                        <td align="center"><%= d.getDescripcioncredito()%></td>
                        <td align="center"><%= d.getDiascredito()%></td>
                        <td><a href="<%= link + d.getIdcredito()%>"> Ver</a></td>                        
                    </tr>
                    <%}%>
                </tbody>
            </table>
