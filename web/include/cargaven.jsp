<%-- 
    Document   : cargaven
    Created on : 6/09/2019, 04:04:53 PM
    Author     : Tecra
--%>
<%@page import="Clase.Vendedores"%>
...
.tbl tr:first-child td:last-child{
    ...
    <body>
        <%            
            ArrayList<Vendedores> list = VendedorCon.listarVendedor2();
            String pag = request.getParameter("pag");
            String link = null;
            String evento = request.getParameter("evento");
            
            if("vendedores".equals(pag)){
                link = "/thermal/Controlador?accion=guardar&tab=vendedores&evento=buscar&par=";
            }
        %>
        <div class="tbl">
