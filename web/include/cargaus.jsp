<%-- 
    Document   : cargaus
    Created on : 14/09/2019, 10:46:07 AM
    Author     : LACET
--%>

<%@page import="java.util.ArrayList"%>
<%@page import="Clase.Usuarios"%>
...
.tbl tr:first-child td:last-child{
    ...
    <body>
        <%
            ...
            ArrayList<Usuarios> list = UsuarioCon.listarUsuarios(nombre);
            String pag = request.getParameter("pag");
            String link = null;
            //el mismo proceso para alumnos, clases y calificaciones
             if("usuarios12".equals(pag)){
                link = "/thermal/Controlador?accion=guardar&tab=usuarios12&evento=buscar&parsin=";
            }else if("permisos".equals(pag)){
                link = "/thermal/Controlador?accion=guardar&tab=usuarios12&evento=buscarpermiso&parsin=";
            }
...
<div class="tbl">
        <table width="100%" border="0">
            <tbody>
                ...
                <% for (Usuarios u : list) {%>
                <tr>
                    <td align="center"><%= u.getIdusuario1()%></td>
                  <td align="center"><%= u.getUsuario()%></td>
                  <td><a href="<%= link + u.getIdusuario1()%>" > Ver</a></td>
                </tr>
                <%}%>
            </tbody>
        </table>
