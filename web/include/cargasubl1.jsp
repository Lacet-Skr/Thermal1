...
.tbl tr:first-child td:last-child{
    ...
    <%
            int descripcion = Integer.parseInt(request.getParameter("linea14"));
            ArrayList<Sublinea> list = SublineaCon.listarSublineas3(descripcion);
            String pag = request.getParameter("pag");
            String link = null;
            String evento = request.getParameter("evento");
            
             if("productos".equals(pag)){
                link = "/thermal/Controlador?accion=guardar&tab=sublineas&evento=buscarpro&par=";
            }
        %>
        <div class="tbl">
            <table width="100%" border="0">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="<%= link + s.getIdsublinea()%>"> Ver</a></td> 
                    </tr>
                    <%}%>
                </tbody>
            </table>
