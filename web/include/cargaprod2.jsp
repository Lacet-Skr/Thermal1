...
<%@page import="Clase.Productos1"%>
<%@page import="Control.Productos1Con"%>
...
.tbl tr:first-child td:last-child{
	border-width:0px 0px 1px 1px;
        ...
        <%
            ...
            ArrayList<Productos> list = ProductosCon.listarProductos(descripcion);
            String pag = request.getParameter("pag");
            String link = null;
            String evento = request.getParameter("evento");
            //el mismo proceso para alumnos, clases y calificaciones
            if("productos".equals(pag)){
                link = "/puntomedicoweb/Controlador?accion=guardar&tab=productos&evento=buscar&par=";
            }//else if("calificaciones".equals(pag)){
                //link = "/puntomedicoweb/Controlador?accion=guardar&tab=calificaciones&evento=buscar&par=";
           // }
        %>
<div class="tbl">
